...
namespace SEDY.PhoneCore
{
    public class MircophoneAccess : IMircophoneAccess
    {
        ...
        public MircophoneAccess(int bufferDur) : this()
        {
            this.bufferDuration = bufferDur;
        }

        public MircophoneAccess(IApplicationService xnaLoopService)
        {
            this.dispatcherService = xnaLoopService;
        }

        public MircophoneAccess(IApplicationService xnaLoopService, int bufferDuration)
        {
            this.dispatcherService = xnaLoopService;
