...
namespace SEDY.PhoneCore.DSP
{
    ...
    /// </summary>
    public class CentralEuropeanEncoding : Encoding
    {
        /// <summary>
        ...
        public CentralEuropeanEncoding()
        {
            FallbackCharacter = '?';
        }
    ...
    /// http://www.hardcodet.net/2010/03/silverlight-text-encoding-class-generator
    /// </summary>
    public class WesternEuropeanEncoding : Encoding
    {
        /// <summary>
        /// Gets the name registered with the
        /// Internet Assigned Numbers Authority (IANA) for the current encoding.
        ...
        public WesternEuropeanEncoding()
        {
            FallbackCharacter = '?';
        }
    ...
    public static class CentralEuropeanEncoder
    {
        ...
        {
            byte[] data = new CentralEuropeanEncoding().GetBytes(s);
